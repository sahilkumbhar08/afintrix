...
const alertConfig = computed(() => {
  ...
  return {
    ...
    description: 'OIDC SSO is currently in beta and free for self-hosted installations. Future updates of Afintrix will require an enterprise license to use this feature.',
    actions: []
  }
})
